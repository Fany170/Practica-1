...
<title>NO ENTENDI NADA XD</title>
...
/* Todo lo que está aquí adentro es diseño */
    ...
    body{
        background-color:#fff700; /* Fondo azul intenso 90s */
        color:#db15a3; /* Texto verde fosforescente */
    ...
    h1{
        font-size:50px; /* Tamaño grande para el HELLO WORLD */
        text-shadow: 3px 3px #001aff; /* Sombra rosa tipo efecto viejo internet */
        margin-top:50px; /* Espacio arriba del título */
    }

    .box{
        border:5px dashed #00ff4c; /* Borde punteado rosa */
        margin:40px auto; /* Espacio exterior y centrado automático */
        padding:20px; /* Espacio interno */
        width:70%; /* Ancho del contenedor */
        background-color:#2200ff; /* Fondo negro dentro del cuadro */
    }
